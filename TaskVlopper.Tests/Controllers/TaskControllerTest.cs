...
namespace TaskVlopper.Controllers.Tests
{
    ...
    {
        TaskController CreateControllerAs(string userName, bool isUserLoggedIn)
        {
        ...
        {
            // Arrange
            TaskController controller = CreateControllerAs("LoggedUser", isUserLoggedIn: true);
        ...
        {
            // Arrange
            TaskController controller = CreateControllerAs("NotLoggedUser", isUserLoggedIn: false);
